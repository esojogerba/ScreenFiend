...
fetchDataFromServer(
    ...
    function ({ genres }) {
        ...
        // Retrieves popular tv show data and passes it in JSON format to heroBanner().
        fetchDataFromServer(
...
const heroBanner = function ({ results: getShowList }) {
    ...
    banner.ariaLabel = "Popular TV Shows";
...
const createShowList = function ({ results: showList }, title) {
    // Creates show-list <section>
    const showListElem = document.createElement("section");
    showListElem.classList.add("movie-list");
    showListElem.ariaLabel = `${title}`;
